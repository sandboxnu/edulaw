      ...
      <Collapse in={selectedIndex === '0'} timeout="auto" unmountOnExit>
        <List component="div" disablePadding>
          <SubMenuItem
            ...
            link={'/studentrights#school-discipline'}
          />
          <SubMenuItem
            label={'Special Education'}
            link={'/studentrights#special-education'}
          />
      ...
      <Collapse in={selectedIndex === '1'} timeout="auto" unmountOnExit>
        <List component="div" disablePadding>
          <SubMenuItem
            ...
            link={'/aboutprs#how-to-file'}
          />
          <SubMenuItem
            label={'When can I file a complaint?'}
            link={'/aboutprs#when-to-file'}
          />
          <SubMenuItem
            label={'Who can file a complaint?'}
            link={'/aboutprs#who-can-file'}
          />
          <SubMenuItem
            label={'What happens when I file?'}
            link={'/aboutprs#what-happens'}
          />
        </List>
      </Collapse>
      <Divider />
